...
public class MagicPloomParticleFallingStar extends BaseMagicPloomParticle {
    protected MagicPloomParticleFallingStar(ClientLevel level, double xCoord, double yCoord, double zCoord,
