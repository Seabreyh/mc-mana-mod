...
public class WorldAttached<T> {
    ...
    // weak references to prevent leaking hashmaps when a WorldAttached is GC'd
    // during runtime
    ...
    public WorldAttached(Function<LevelAccessor, T> factory) {
        ...
        // Weak key hashmaps prevent worlds not existing anywhere else from leaking
        // memory.
        // This is only a fallback in the event that unload events fail to fire for any
        // reason.
