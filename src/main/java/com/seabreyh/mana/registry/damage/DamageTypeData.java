...
import com.seabreyh.mana.registry.damage.WorldAttached;
...
/**
 * An extension of {@link DamageType} that contains extra data, functionality,
 * and utility.
 * 
 * @see DamageType
 * @see DamageSource
...
public class DamageTypeData {
    ...
    public static class Builder {
        ...
        public Builder location(String path) {
            return location(ManaMod.asResource(path));
        }
        ...
        public Builder simpleId(String path) {
            return simpleId(ManaMod.asResource(path));
        }

        /**
         * Set the message ID. this is used for death message lang keys. This is a
         * required field.
         *
        ...
        /**
         * Set the exhaustion of this type. This is the amount of hunger that will be
         * consumed when an entity is damaged.
         */
        ...
        /**
         * Set the scaling of this type. This determines whether damage is increased
         * based on difficulty or not.
         */
        ...
        /**
         * Set the effects of this type. This determines the sound that plays when
         * damaged.
         */
        ...
        /**
         * Set the death message type of this damage type. This determines how a death
         * message lang key is assembled.
         * <ul>
         * <li>{@link DeathMessageType#DEFAULT}:
         * {@link DamageSource#getLocalizedDeathMessage}</li>
         * <li>{@link DeathMessageType#FALL_VARIANTS}:
         * {@link CombatTracker#getFallMessage(CombatEntry, Entity)}</li>
         * <li>{@link DeathMessageType#INTENTIONAL_GAME_DESIGN}: "death.attack." +
         * msgId, wrapped in brackets, linking to MCPE-28723</li>
         * </ul>
         */
