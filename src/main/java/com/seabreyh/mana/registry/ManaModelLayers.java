...
@OnlyIn(Dist.CLIENT)
public class ManaModelLayers {
    private static final Set<ModelLayerLocation> ALL_MODELS = Sets.newHashSet();
    public static final ModelLayerLocation CELESTIAL_BOOMERANG = register("celestial_boomerang");
    ...
    public static ModelLayerLocation createSignModelName(WoodType p_171292_) {
        ...
        return new ModelLayerLocation(new ResourceLocation(location.getNamespace(), "sign/" + location.getPath()),
                "main");
    }
