package com.seabreyh.mana.entity.throwable;
...
public class CelestialBoomerangEntity extends ThrowableProjectile {
    private int life;
    ...
    public CelestialBoomerangEntity(Level world, LivingEntity player) {
    ...
    public CelestialBoomerangEntity(EntityType<? extends CelestialBoomerangEntity> entityType, Level entityLevel) {
