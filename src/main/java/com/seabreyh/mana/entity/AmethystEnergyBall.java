...
// @Override
// public void shoot(double p_37266_, double p_37267_, double p_37268_, float
// p_37269_, float p_37270_) {
...
// if (flag) {
// this.setYRot((float) (Mth.atan2(-d5, -d1) * (double) (180F / (float)
// Math.PI)));
// } else {
// this.setYRot((float) (Mth.atan2(d5, d1) * (double) (180F / (float)
// Math.PI)));
...
// this.setXRot((float) (Mth.atan2(d6, d4) * (double) (180F / (float)
// Math.PI)));
...
// this.level().getBlockState(hitBlock.getBlockPos().above());
...
// if (fireCharged || this.wasOnFire || blockstateAbove.getBlock() ==
// Blocks.FIRE
...
// LivingEntity livingentity = entity1 instanceof LivingEntity ? (LivingEntity)
// entity1 : null;
