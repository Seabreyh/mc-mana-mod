...
import com.seabreyh.mana.client.renderers.CaughtStarRenderer;
...
public class ManaClientEvents {
    ...
    public static void registerEntityRenderers(FMLClientSetupEvent event) {
        ...
        // EntityRenderers.register(ManaEntities.CAUGHT_STAR.get(), CaughtStarRenderer::new);
        // EntityRenderers.register(ManaBlocks.STAR_CATCHER.get(), CaughtStarRenderer::new);
    }
    ...
    public static void registerBlockEntityRenderers(FMLClientSetupEvent event) {
        // event.registerEntityRenderer(ManaEntities.AMETHYST_ENERGY_BALL.get(), AmethystEnergyBallRenderer::new);
        // event.registerEntityRenderer(ManaEntities.EMERALD_ENERGY_BALL.get(), EmeraldEnergyBallRenderer::new);
        // event.registerEntityRenderer(ManaEntities.FALLEN_STAR.get(), FallenStarRenderer::new);
        BlockEntityRenderers.register(ManaBlockEntities.STAR_CATCHER_ENTITY_BLOCK.get(), CaughtStarRenderer::new);
        // event.registerEntityRenderer(ManaBlocks.STAR_CATCHER.get(), CaughtStarRenderer::new);
    }
