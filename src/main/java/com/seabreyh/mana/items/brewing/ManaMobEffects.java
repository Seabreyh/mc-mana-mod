...
public class ManaMobEffects {
    ...
    public static final RegistryObject<MobEffect> ARMOR = MOB_EFFECTS.register("armor", () -> new ManaMobEffect(MobEffectCategory.BENEFICIAL, 0x888888).addAttributeModifier(Attributes.ARMOR, "68685544-A337-4959-B1AD-ACCE62A583BE", 4D, AttributeModifier.Operation.ADDITION));
