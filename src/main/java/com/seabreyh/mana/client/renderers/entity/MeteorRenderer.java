...
public class MeteorRenderer extends EntityRenderer<Meteor> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("base",
                CubeListBuilder.create().texOffs(0, 16).addBox(-6.0F, 0.0F, -6.0F, 12.0F, 4.0F, 12.0F), PartPose.ZERO);
        return LayerDefinition.create(meshdefinition, 64, 32);
    }

    public void render(Meteor p_114162_, float p_114163_, float p_114164_, PoseStack p_114165_,
    ...
    public boolean shouldRender(Meteor p_114169_, Frustum p_114170_, double p_114171_, double p_114172_,
            double p_114173_) {
