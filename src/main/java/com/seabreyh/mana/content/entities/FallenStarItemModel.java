...
// public class FallenStarItemModel extends AdvancedEntityModel<Entity> {
...
// root.addChild(head);
// head.setTextureOffset(14, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 2.0F,
// 0.0F, false);
// head.setTextureOffset(0, 19).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 2.0F,
// 0.0F, false);

// body1 = new AdvancedModelBox(this, "body1");
// body1.setPos(0.0F, 0.0F, 0.0F);
// head.addChild(body1);
// body1.setTextureOffset(0, 11).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F,
// 0.0F, false);

// body2 = new AdvancedModelBox(this, "body2");
// body2.setPos(0.0F, 0.0F, 5.0F);
// body1.addChild(body2);
// body2.setTextureOffset(10, 14).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 5.0F,
// 0.1F, false);

// body3 = new AdvancedModelBox(this, "body3");
// body3.setPos(0.0F, 0.0F, 5.0F);
// body2.addChild(body3);
// body3.setTextureOffset(0, 0).addBox(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 7.0F,
// 0.0F, false);
...
// @Override
// public void renderToBuffer(PoseStack matrixStack, VertexConsumer buffer, int
// packedLight, int packedOverlay,
// float red, float green, float blue, float alpha) {
// root.render(matrixStack, buffer, packedLight, packedOverlay);
// }

// public void setRotationAngle(AdvancedModelBox AdvancedModelBox, float x,
// float y, float z) {
...
// : partialTick + Minecraft.getInstance().player.tickCount;
...
// this.chainWave(tail, 0.7F, 0.2F, -3, tick, Mth.clamp((float) (1.0F +
// Math.sin(tick * 0.04)), 0, 0.5F) * 2);
