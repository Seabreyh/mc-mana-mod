...
public class MagicPloomParticleFire extends BaseMagicPloomParticle {
    protected MagicPloomParticleFire(ClientLevel level, double xCoord, double yCoord, double zCoord,
