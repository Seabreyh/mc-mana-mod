...
// ResourceLocation(ManaMod.MOD_ID, "staff_table");
...
// @Override
// public StaffTableRecipes fromNetwork(ResourceLocation id, FriendlyByteBuf
// buf) {
// NonNullList<Ingredient> inputs = NonNullList.withSize(buf.readInt(),
// Ingredient.EMPTY);
