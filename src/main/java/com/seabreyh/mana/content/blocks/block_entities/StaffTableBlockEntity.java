...
// public class StaffTableBlockEntity extends BlockEntity implements
// MenuProvider {
...
// UPDATE TO THE AMOUNT OF SLOTS YOU HAVE
// @Override
...
// {
// super(ManaBlockEntities.STAFF_TABLE_ENTITY_BLOCK.get(), pWorldPosition,
// pBlockState);
...
// SimpleContainer(entity.itemHandler.getSlots());
// entity.match =
// level.getRecipeManager().getRecipeFor(StaffTableRecipes.Type.INSTANCE,
// inventory, level);
// try {
...
// return ItemStack.matches(entity.itemHandler.getStackInSlot(4), new
...
// // check here individual slots 1,2,and 3 for the ingredients from json
// file?????
...
// entity.itemHandler.insertItem(0, new
// ItemStack(ManaItems.EMPTY_MANA_CAPSULE.get()), false);

// level.playSound((Player) null, pPos.getX(), pPos.getY(), pPos.getZ(),
...
// {
// return entity.itemHandler.getStackInSlot(4).getCount() <
// entity.itemHandler.getStackInSlot(4).getMaxStackSize();
// }

// private static boolean canInsertItemIntoOutputSlot(SimpleContainer inventory,
// ItemStack output) {
// return inventory.getItem(4).getItem() == output.getItem() ||
// inventory.getItem(4).isEmpty();
// }

// private static boolean hasManaCapsule(StaffTableBlockEntity entity) {
// return entity.itemHandler.getStackInSlot(0).getItem() ==
// ManaItems.FILLED_MANA_CAPSULE.get();
// }

// private static boolean canInsertAmountIntoOutputSlot(SimpleContainer
// inventory) {
// return inventory.getItem(4).getMaxStackSize() >
