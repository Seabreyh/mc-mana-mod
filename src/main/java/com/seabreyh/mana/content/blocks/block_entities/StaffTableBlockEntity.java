...
public class StaffTableBlockEntity extends BlockEntity implements
    ...
    Optional<StaffTableRecipe> match;
    ...
    public StaffTableBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(ManaBlockEntities.STAFF_TABLE_BLOCK_ENTITY.get(), pWorldPosition,
                pBlockState);
    ...
    public static void tick(Level pLevel, BlockPos pPos, BlockState pState,
        ...
        if (!pLevel.isClientSide) {
            ...
            if (hasRecipe(entity)) {
                ...
                entity.match = level.getRecipeManager().getRecipeFor(StaffTableRecipe.Type.INSTANCE,
                        inventory, level);
                try {
    ...
    private static boolean hasRecipe(StaffTableBlockEntity entity) {
        ...
        entity.match = level.getRecipeManager()
                .getRecipeFor(StaffTableRecipe.Type.INSTANCE, inventory, level);
